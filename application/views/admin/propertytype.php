                            ...
                            <form role="form" action="<?php echo base_url() ?>admin/add_category_post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="property_type_name"> Property Type Name<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control required" name="property_type_name">
                                        <span class="text-danger error-span">This input is required.</span>

                                        <input type="hidden" value="tbl_property_type" name="table_name">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <?php $record_13=$this->common_model->get_records('tbl_master', "status = '0'");?>
                                        <select class="selectpicker w100 show-tick form-control required"
                                            ...
                                            <option value="<?= $record13->id;?>" id="<?= $record13->id;?>">
                                                <?= $record13->property_status;?></option>
                                            <?php endforeach;?>
                                        </select>
                                        <span class="text-danger error-span">This input is required.</span>
                                    </div>
                    ...
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="builder" data-sortable="true">Property Type Name</th>
						...
						?>
                                <tr>
                                    ...
                                    <td><?php echo $inc; ?></td>
                                    <?php $record_13=$this->common_model->get_records('tbl_master', "status = '0' and id='$record->property_status_id'")[0];?>
                                        
                                    <td><?php echo $record_13->property_status; ?></td>
                                ...
                                $('.update_data input[name=property_type_name]').val('<?=$record->property_type_name?>');
                                $('.update_data select[name=property_status_id]').val('<?=$record->property_status_id?>');
							...
							$('.update_data .img2').attr('src', '<?=base_url()?>uploads/common/<?=$record->mobile_img_url?>');
								...
								"><i class="fe-edit"></i></button>
                                        ...
                                        <a class="btn btn-sm btn-danger  deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_property_type')"
                                            style="<?php if($record->status == 1){ echo 'display: none;'; } ?>" href="#"
                                            data-table="tbl_property_type" data-id="<?php echo $record->id; ?>"><i
