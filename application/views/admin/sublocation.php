                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Sub Location</a></li>
                            ...
                            <form role="form" action="<?php echo base_url() ?>admin/add_category_post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="sub_location_name">Sub Location Name<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control required" name="sub_location_name">
                                        <span class="text-danger error-span">This input is required.</span>


                                        <input type="hidden" value="tbl_sub_location" name="table_name">
                                    ...
                                    <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <?php $record_13=$this->common_model->get_records('tbl_locations', "status = '0'");?>
                    ...
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="builder" data-sortable="true">Sub Location Name</th>
                                    <th data-field="builder" data-sortable="true">Location</th>
						...
						?>
                                <tr>
                                    ...
                                    <td><?php echo $record->sub_location_name ?></td>
                                    <?php $record_13=$this->common_model->get_records('tbl_locations', "status = '0' and id='$record->location_id'")[0];?>
                                        
                                        <td><?php echo $record_13->location_name; ?></td>
                                ...
                                $('.update_data input[name=sub_location_name]').val('<?=$record->sub_location_name?>');
                                $('.update_data select[name=location_id').val('<?=$record->location_id?>');
							...
							$('.update_data .img2').attr('src', '<?=base_url()?>uploads/common/<?=$record->mobile_img_url?>');
								...
								"><i class="fe-edit"></i></button>
                                        ...
                                        <a class="btn btn-sm btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_sub_location')"
                                            style="<?php if($record->status == 1){ echo 'display: none;'; } ?>" href="#"
                                            data-table="tbl_sub_location" data-id="<?php echo $record->id; ?>"><i
