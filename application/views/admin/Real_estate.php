                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Realestate</a></li>
					...
					<table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                    ...
                                    <tr>
                                        ...
                                        <th data-field="title" data-sortable="true" data-formatter="">Title</th>

                                        <th data-field="Description" data-sortable="true" data-formatter="">Description</th>

                                        <th data-field="bg image" data-sortable="true" data-formatter="">Bg image</th>
                                        <th data-field="linkcall " data-sortable="true" data-formatter="">Link call to action text</th>
						...
						?>
                                    <tr>
                                        ...
                                        <td><a target="_blank"
                                            href="<?=base_url()?>uploads/common/<?php echo $record->bg_image ?>"><img
                                                width="50" height="50"
                                                src="<?=base_url()?>uploads/common/<?php echo $record->bg_image ?>"></a>
                                    </td>
                                        <td><?php echo $record->link_call_to_action_text ?></td>
									...
									$('.update_data input[name=row_id]').val('<?=$record->id?>');
                                     ...
                                     $('.update_data .img-a').attr('href', '<?=base_url()?>uploads/common/<?=$record->bg_image?>');
							$('.update_data .img1').attr('src', '<?=base_url()?>uploads/common/<?=$record->bg_image?>');

						


									 $('.update_data input[name=bg_image]').val(`<?=$record->bg_image?>`);
									 $('.update_data input[name=link_call_to_action_text]').val(`<?=$record->link_call_to_action_text?>`);
									...
									"><i class="fe-edit"></i></a>
                                            ...
                                            <a class="btn btn-sm btn-success activebtn"
                                                style="<?php if($record->status == 0){ echo 'display: none;'; } ?>"
                                                href="#" data-table="tbl_search_smarter_from_anywhere"
                                                data-id="<?php echo $record->id; ?>"><i class="fa fa-check"></i></a>
                                            <?php endif; ?>
                                        </td>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="hidden" value="tbl_search_smarter_from_anywhere" name="table_name">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="link_call_to_action_text">Link call to action text</label>
                                <input type="text" class="form-control" name="link_call_to_action_text">
                            </div>
                        </div>
