                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Builder Registration</a></li>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="user_type">Type<span class="text-danger">*</span></label>
                                            ...
                                            <span class="text-danger error-span">Input Is required</span>
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                ...
                                <tr>
                                    ...
                                    <th data-field="buildertype" data-sortable="true">Builder Type</th>
                                    ...
                                    <th data-field="isfront" data-sortable="true">Is Front</th>

                                    <th data-field="created Day/Time" data-sortable="true">Created Day/Time</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $record->mobile ?></td>
                                      <td class="text-center">
                                        <a class="btn btn-sm <?php if($record->is_front=='0'){echo "btn-success";}else{echo "btn-danger";}?>" onclick="statusChange(this,<?= $record->id;?>,<?=$record->is_front?>,'is_front','tbl_builder_register')"
                                           href="#"
                                            data-table="tbl_property_details" data-id="<?php echo $record->id; ?>"><i
                                                class="fa <?php if($record->is_front=='0'){echo "fa-check";}else{echo "fa-times";}?>"></i></a>
                                 ...
                                 $datetime = new DateTime($myvalue);
                                  ...
                                  ?>
                                    ...
                                    $('.update_data input[name=built_up_area]').val('<?=$record->built_up_area?>');
                                 
                                    
									$('.update_data input[name=row_id]').val('<?=$record->id?>');
									$('.update_data input[name=status]').val('<?=$record->status?>');

                                    $('.update_data select[name=name]').val('<?=$record->name?>');
									...
									"><i class="fe-edit"></i></a>
                                        ...
                                        <a class="btn btn-sm btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_builder_register')"
                                            style="<?php if($record->status == 1){ echo 'display: none;'; } ?>" href="#"
                                            data-table="tbl_builder_register" data-id="<?php echo $record->id; ?>"><i
