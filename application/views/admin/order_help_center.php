                ...
                <div class="box-body table-responsive">
                  <table class="table table-hover data_table">
					...
					<tbody>
						...
						<tr>
							<td><?php echo $inc; ?></td>
							<td><?php echo date('h:ia / d M, Y', strtotime($record->date_time)) ?></td>
							<td><?php echo $record->order_id ?></td>
							<td><?php echo $record->subject ?></td>
							<td><?php echo $record->message ?></td>
							<td>
								<form class="update_data">
									<input type="hidden" name="table_name" value="tbl_order_enquiry"> 
												...
												<div class="col-md-12">                                
													<div class="form-group">
														...
														<div style="height: 500px;overflow-y: scroll;">
															<?php 
																foreach($this->common_model->get_records("tbl_order_enquiry_comments", "status = '0' and order_id = '" .$record->order_id . "' order by id desc") as $comment):
																	?>
																		<div class="well">
																			<h4>
															...
															?>
															<?php
																if(sizeof($this->common_model->get_records("tbl_order_enquiry_comments", "status = '0' and order_id = '" .$record->order_id . "' order by id desc")) < 1)
																{
																	?>
											...
											<div class="row">
												<div class="col-md-12">                                
													<form class="insert_data" this_id="form-<?=uniqid()?>" reload-action="true">
														<div class="form-group">
															<input type="hidden" name="table_name" value="tbl_order_enquiry_comments">
