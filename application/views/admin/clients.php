            ...
            <div class="col-md-12">
			  ...
			  <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id" data-page-list="[5, 10, 20]" data-page-size="5" data-pagination="true" data-show-pagination-switch="true" class="table-borderless">
						...
						<tr>
							...
							<th data-field="des" data-sortable="true" data-formatter="">Description</th>
						...
						<tr>
							...
							<td class="text-center">
								<?php if($record->id != 0): ?>
									...
									<a class="btn btn-sm btn-success activebtn" style="<?php if($record->status == 0){ echo 'display: none;'; } ?>" href="#" data-table="tbl_our_clientstitle" data-id="<?php echo $record->id; ?>"><i class="fa fa-check"></i></a>
								<?php endif; ?>
							</td>
                ...
                <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="tbl_our_clientstitle" name="table_name">
