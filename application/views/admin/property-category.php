                            ...
                            <form role="form" action="<?php echo base_url() ?>admin/add_category_post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="tbl_property_category">Property Category<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control required" name="property_category">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <?php $record_13=$this->common_model->get_records('tbl_property_type', "status = '0'");?>
                                            <select class="selectpicker w100 show-tick form-control required"
                                                ...
                                                <option value="<?= $record13->id;?>" id="<?= $record13->id;?>">
                                                    <?= $record13->property_type_name;?></option>
                                                <?php endforeach;?>
                                            </select>
                                            <span class="text-danger error-span">This input is required.</span>
                                        </div>
                    ...
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="builder" data-sortable="true">Property Category</th>
						...
						?>
                                <tr>
                                    ...
                                    <?php $record_13=$this->common_model->get_records('tbl_property_type', "status = '0' and id='$record->property_type_id'")[0];?>
                                        

                                    <td><?php echo $record_13->property_type_name; ?></td>
                                    <td><?php echo $record->property_category ?></td>
								...
								$('.update_data input[name=property_category]').val('<?=$record->property_category?>');
								$('.update_data select[name=property_type_id]').val('<?=$record->property_type_id?>');
							...
							$('.update_data .img2').attr('src', '<?=base_url()?>uploads/common/<?=$record->mobile_img_url?>');
								...
								"><i class="fe-edit"></i></button>
                                        ...
                                        <a class="btn btn-sm btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_category')"
                                            style="<?php if($record->status == 1){ echo 'display: none;'; } ?>" href="#"
                                            data-table="tbl_category" data-id="<?php echo $record->id; ?>"><i
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <label for="property_category">Property Category<span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control required" name="property_category">
