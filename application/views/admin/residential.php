                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);"> Residential sale</a></li>
                    ...
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" value="tbl_residential" name="table_name">
                                    ...
                                    <th data-field="yourmessage" data-sortable="true">  Your Message</th>
						...
						?>
                                <tr>
                                    ...
                                    <td><?php echo $record->yourmessage ?></td>
