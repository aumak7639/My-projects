	<div class="content-wrapper">
		...
		<section class="content">
			<div class="row">
				<form this_id="form-001" class="insert_data" method="post" role="form" reload-action="true">
					<div class="col-md-12">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="tags" placeholder="Seperate by comma">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
