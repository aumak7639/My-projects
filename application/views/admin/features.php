                            ...
                            <form role="form" action="<?php echo base_url() ?>admin/add_category_post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="feature">Feature <span
                                        ...
                                        <input type="hidden" value="tbl_features" name="table_name">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="desktop_image">desktop_url</label>
                                        <input type="file" class="form-control" name="desktop_image">
                                    </div>

                                    <div class="form-group col-md-6">

                                        <label for="mobile_image">mobile_url</label>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="builder" data-sortable="true">Feature</th>
						...
						?>
								...
								$('.update_data input[name=feature]').val('<?=$record->feature?>');
							
								$('.update_data .img-a').attr('href', '<?=base_url()?>uploads/common/<?=$record->desktop_image?>');
							...
							$('.update_data .img2').attr('src', '<?=base_url()?>uploads/common/<?=$record->mobile_image?>');
								...
								"><i class="fe-edit"></i></button>
                                        ...
                                        <a class="btn btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_features')"
