                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="tbl_brands" name="table_name">
							...
							<div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control required" required accept="image/x-png,image/gif,image/jpeg" name="small">
										<span class="text-danger error-span">This input is required.</span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="box-body table-responsive">
                  <table class="table table-hover data_table">
					...
					<tbody>
						...
						<tr>
						  <td><?php echo $inc; ?></td>
						  <td><a target="_blank" href="<?=base_url()?>uploads/brands/<?php echo $record->small ?>"><img width="50" height="50" src="<?=base_url()?>uploads/brands/<?php echo $record->small ?>"></a></td>
						  ...
						  <td class="text-center">
							...
							<a class="btn btn-sm btn-info" data-toggle="modal" data-target="#addSlider" onclick="$('#addSlider input[name=brand_id]').val('<?=$record->id?>')"><i class="fa fa-plus"></i></a>
							<?php endif; ?>
							<a class="btn btn-sm btn-warning" data-toggle="modal" data-target="#modal-default" onclick="
							$('.update_data #img-004').attr('src', '<?=base_url()?>uploads/brands/<?=$record->extra_large?>');
							$('.update_data #img-003').attr('src', '<?=base_url()?>uploads/brands/<?=$record->large?>');
							$('.update_data #img-002').attr('src', '<?=base_url()?>uploads/brands/<?=$record->medium?>');
							$('.update_data #img-001').attr('src', '<?=base_url()?>uploads/brands/<?=$record->small?>');
							...
							<a class="btn btn-sm btn-success activebtn" style="<?php if($record->status == 0){ echo 'display: none;'; } ?>" href="#" data-table="tbl_brands" data-id="<?php echo $record->id; ?>"><i class="fa fa-check"></i></a>
			...
			<form reload-action="true" this_id="form-002" class="update_data" method="post" role="form">
				...
				<div class="modal-body">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="slug">Extra Large Image</label>
								<input type="file" class="form-control" accept="image/x-png,image/gif,image/jpeg" name="extra_large">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="slug">Large Image</label>
								<input type="file" class="form-control" accept="image/x-png,image/gif,image/jpeg" name="large">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="slug">Medium Image</label>
								<input type="file" class="form-control" accept="image/x-png,image/gif,image/jpeg" name="medium">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="slug">Small Image</label>
								<input type="file" class="form-control" accept="image/x-png,image/gif,image/jpeg" name="small">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-3">
							<div class="form-group">
								<label for="slug">Extra Large Image</label>
								<img src="#" id="img-004" class="w--100">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="slug">Large Image</label>
								<img src="#" id="img-003" class="w--100">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="slug">Medium Image</label>
								<img src="#" id="img-002" class="w--100">
							</div>
						</div>
						<div class="col-md-3">
							<div class="form-group">
								<label for="slug">Small Image</label>
								<img src="#" id="img-001" class="w--100">
							</div>
						</div>
					</div>
				</div>
