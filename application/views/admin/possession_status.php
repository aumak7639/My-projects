                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Possession Status</a></li>
                            ...
                            <form role="form" action="<?php echo base_url() ?>admin/add_category_post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="possession_name">Possession Name <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control required" name="possession_name">
                                        <span class="text-danger error-span">This input is required.</span>


                                        <input type="hidden" value="tbl_possession_status" name="table_name">
                    ...
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="builder" data-sortable="true">possession Name</th>
						...
						?>
                                <tr>
                                    ...
                                    <td><?php echo $record->possession_name ?></td>
								...
								$('.update_data input[name=possession_name]').val('<?=$record->possession_name?>');
							...
							$('.update_data .img2').attr('src', '<?=base_url()?>uploads/common/<?=$record->mobile_img_url?>');
								...
								"><i class="fe-edit"></i></button>
                                        ...
                                        <a class="btn btn-sm btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_possession_status')"
                                            style="<?php if($record->status == 1){ echo 'display: none;'; } ?>" href="#"
                                            data-table="tbl_possession_status" data-id="<?php echo $record->id; ?>"><i
