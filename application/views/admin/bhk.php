                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">BHK</a></li>
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="builder" data-sortable="true">BHK</th>
						...
						?>
								...
								$('.update_data input[name=bhk_no]').val('<?=$record->bhk_no?>');
							...
							$('.update_data .img2').attr('src', '<?=base_url()?>uploads/common/<?=$record->mobile_img_url?>');
								...
								"><i class="fe-edit"></i></button>
                                        ...
                                        <a class="btn btn-sm btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_bhk')"
