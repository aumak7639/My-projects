                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Property Section</a></li>
                            ...
                            <div class="row">
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="tbl_what_are_you_looking_for_section_add" name="table_name">
            ...
            <div class="col-md-12">
			  ...
			  <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
						...
						<tr>
							...
							<th data-field="no" data-sortable="true" data-formatter="">SI.no</th>
							 <th data-field="icon" data-sortable="true" data-formatter="">Icon</th>
						...
						<tr>
							...
							<td class="text-center">
								<?php if($record->id != 0): ?>
									...
									<a class="btn btn-sm btn-success activebtn" style="<?php if($record->status == 0){ echo 'display: none;'; } ?>" href="#" data-table="tbl_what_are_you_looking_for_section_add" data-id="<?php echo $record->id; ?>"><i class="fa fa-check"></i></a>
								<?php endif; ?>
							</td>
