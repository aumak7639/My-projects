                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Transaction Type</a></li>
                            ...
                            <form role="form" action="<?php echo base_url() ?>admin/add_category_post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="hidden" value="tbl_transaction_type" name="table_name">
                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="builder" data-sortable="true">Transaction Type</th>
						...
						?>
								...
								$('.update_data input[name=transaction_type]').val('<?=$record->transaction_type?>');
							...
							$('.update_data .img2').attr('src', '<?=base_url()?>uploads/common/<?=$record->mobile_img_url?>');
								...
								"><i class="fe-edit"></i></button>
                                        ...
                                        <a class="btn btn-sm btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_transaction_type')"
                                            style="<?php if($record->status == 1){ echo 'display: none;'; } ?>" href="#"
                                            data-table="tbl_transaction_type" data-id="<?php echo $record->id; ?>"><i
