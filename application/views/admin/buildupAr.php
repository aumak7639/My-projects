                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Build Up Area</a></li>
                            ...
                            <form role="form" action="<?php echo base_url() ?>admin/add_category_post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="built_up_area">Built up Area <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control required" name="built_up_area">

                                        <span class="text-danger error-span">This input is required.</span>
                                        <input type="hidden" value="tbl_built_up_area" name="table_name">
                    ...
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="builder" data-sortable="true">Build Up Area</th>
						...
						?>
                                <tr>
                                    ...
                                    <td><?php echo $record->built_up_area ?></td>
							...
							$('.update_data .img2').attr('src', '<?=base_url()?>uploads/common/<?=$record->mobile_img_url?>');
								...
								"><i class="fe-edit"></i></button>
                                        ...
                                        <a class="btn btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_built_up_area')"
                                            style="<?php if($record->status == 1){ echo 'display: none;'; } ?>"
                                            data-table="tbl_built_up_area" data-id="<?php echo $record->id; ?>"><i
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="built_up_area">builder Area <span
                                                    class="text-danger">*</span></label>
                                            <input type="text" class="form-control required" name="built_up_area">
                                            <span class="text-danger error-span">This input is required.</span>
