                ...
                <div class="col-sm-12">
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th data-field="builder" data-sortable="true">Tags</th>

                                    <th data-field="img1" data-sortable="true">Slugs</th>
						...
						?>
								...
								$('.update_data input[name=tags]').val('<?=$record->tags?>');
								$('.update_data input[name=slugs]').val('<?=$record->slugs?>');
								...
								"><i class="fe-edit"></i></button>
                                        ...
                                        <a class="btn btn-danger deletecats <?= $record->id;?>" onclick="myFunction(this,<?= $record->id;?>,'tbl_tags')"
