<div class="content-page">
    <div class="content">
                            ...
                            <thead class="thead-light">
                                ...
                                <tr>
                                    ...
                                    <th data-field="id" data-sortable="true" data-formatter="">Sno</th>
                                       ...
                                       <th data-field="propertyid" data-sortable="true" data-formatter="">Property ID</th>
                                    ...
                                    <th data-field="enquiry" data-sortable="true" data-formatter="">Enquiries</th>
                                    <th data-field="fav" data-sortable="true" data-formatter="">Favourites</th>
                                    <th data-field="view" data-sortable="true" data-formatter="">Recently Viewed</th>
                                    <th data-field="vi" data-sortable="true" data-formatter="">Tags</th>

                                    <!--<th data-field="review" data-sortable="true" data-formatter="">Reviews</th>-->
                                    ...
                                    <th data-field="isfeatured" data-sortable="true" data-formatter="">Is Featured</th>

                                 
                                    <th data-field="arp" data-sortable="true" data-formatter="">Assured Return Projects</th>
       ...
       <?php $lists=$this->common_model->get_custom_query("select * from tbl_user_wishlist WHERE item_id='$record->id'  and status='0' ");


        $reviews=$this->common_model->get_records('tbl_user_reviews', "status = '0' and  property_id='$record->id'");

        $viewed=$this->common_model->get_records('tbl_recently_viewed', "status = '0' and  item_id='$record->id'");
        $enquiries=$this->common_model->get_custom_query("select * from tbl_enquiry WHERE item_id='$record->id'  and status='0' ");
        $fav_count=sizeof($lists);
        $review_count=sizeof($reviews);
        $enquiry_count=sizeof($enquiries);
        $view_count=sizeof($viewed);
?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $inc; ?></td>
                                     <?php $info=$this->common_model->get_records('tbl_detailed_property_info', "status='0' and id='$record->detailed_property_info_id'")[0];?>
                                    <td>
                                                      <a href="<?=base_url()?>admin/property-list/<?=$record->id?>"><?=$info->property_id?></a>
                                                        
                                    </td>
                                    <td><?php echo $record->property_name ?></td>
                                    <td><?php echo $record->price ?></td>
                                    <td><?php echo $record->area ?></td>
                                     <?php $enquiry=$this->common_model->get_custom_query("select count(id) as count from tbl_enquiry where status='0' and item_id='$record->id'")[0];?>
                                    
                                    <td><a href="<?=base_url()?>admin/enquiry/<?=$record->id?>"><?php echo $enquiry->count ?></a></td>

                                    <td><a href="<?=base_url()?>admin/user/<?=$record->id?>/1"><?php echo $fav_count ?></a></td>


                                    <td><a href="<?=base_url()?>admin/user/<?=$record->id?>/3"><?php echo $view_count ?></a></td>
                                    <td>
                                    <ul>

                                    
                                    <?php
                                    if($record->tags){ $keywords = explode(",", $record->tags);
							...
							?>
                            <li class="mb-3" style="display: inline;"
><?=$keyword?></li>
...
<a class="btn btn-primary" href="<?=base_url()?>admin/assign_tags/<?=$record->id?>">Add Tags</a>
                                ...
                                <!--     <td><a href="<?=base_url()?>admin/user/<?=$record->id?>/2"><?php echo $review_count ?></a></td>-->
                                 ...
                                 $datetime = new DateTime($myvalue);
                                  ...
                                  ?>
                                    ...
                                    <td class="text-center">
                                       ...
                                       <td class="text-center">
                                        <a class="btn btn-sm <?php if($record->is_featured=='0'){echo "btn-success";}else{echo "btn-danger";}?>" onclick="statusChange(this,<?= $record->id;?>,<?=$record->is_featured?>,'is_featured','tbl_property_details')"
                                           href="#"
                                            data-table="tbl_property_details" data-id="<?php echo $record->id; ?>"><i
                                       ...
                                       <td class="text-center">
                                       <a class="btn btn-sm <?php if($record->assured_return_projects=='0'){echo "btn-success";}else{echo "btn-danger";}?>" onclick="statusChange(this,<?= $record->id;?>,<?=$record->assured_return_projects?>,'assured_return_projects','tbl_property_details')"
                                           href="#"
                                            data-table="tbl_property_details" data-id="<?php echo $record->id; ?>"><i
                                                class="fa <?php if($record->assured_return_projects=='0'){echo "fa-check";}else{echo "fa-times";}?>"></i></a>
...
<script>
                                  $("#tag").change(function(){
  alert("hi");
  //call ajax and send multiply selected values here
