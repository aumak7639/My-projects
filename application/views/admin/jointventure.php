<div class="content-page">
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Joint ventures</a></li>
 ...
 --> 
            ...
            <div class="row">
                <div class="col-md-12">
                    <form  this_id="form-001" class="insert_admin" method="post" role="form" enctype="multipart/form-data">
                    <div class="card-box">
                        ...
                        <table data-toggle="table" data-search="true" data-show-refresh="true" data-sort-name="id"
                            ...
                            <thead class="thead-light">
                                ...
                                <tr>
                                    ...
                                    <input type="hidden" value="tbl_ventures" name="table_name">
                                    ...
                                    <th data-field="propertytype" data-sortable="true">Property Type</th>
						...
						?>
                                <tr>
                                    ...
                                    <td><?php echo $record->propertytype ?></td>
                                    <td><?php echo $record->zone ?></td>
                                    <td><?php echo $record->landmark ?></td>
                                      <td><?php echo $record->additionalinfo ?></td>
