...
class Email_model extends CI_Model
{
	function contact_us($id)
	{
		...
		$subject = "Someone Contacted You - furn2fit.com";
		...
		$msg_email = "
			Someone Contacted You - <a href='" . base_url() . "'>furn2fit.com</a>\r\n
			Name: $name\r\n
			Email: $email\r\n
			Mobile: $phone\r\n
			Subject: $subject\r\n
			Message: $message\r\n
			<a href='" . base_url() . "admin'>Login Furn2Fit admin account.</a>
		";
	...
	function new_seller_register($seller_id)
	{
		...
		$subject = "New Seller Registered - furn2fit.com";
		...
		$msg_email = "
			New Seller Registered - <a href='" . base_url() . "'>furn2fit.com</a>\r\n
			Name: $name\r\n
			Email: $email\r\n
			Mobile: $phone\r\n
			<a href='" . base_url() . "admin'>Login Furn2Fit admin account.</a>
	...
	function new_product($product_id)
	{
		...
		$subject = "New product has been uploaded in our system - furn2fit.com";
		...
		$msg_email = "
			New product has been uploaded in our system - <a href='" . base_url() . "'>furn2fit.com</a>\r\n
			Name: $name\r\n
			Store ID: $store_id\r\n
			<a href='" . base_url() . "admin'>Login Furn2Fit admin account.</a>
		";
	...
	function new_quote_request($info)
	{
		...
		$subject = "New Quote Request - furn2fit.com";
		...
		$msg_email = "
			New Quote Request - <a href='" . base_url() . "'>furn2fit.com</a>\r\n
			Product Name: " . $product_name . " \r\n 
			Name: " . $info['name'] . " \r\n 
			Notes: " . $info['notes'] . " \r\n 
			Quantity: " . $info['quantity'] . "\r\n
